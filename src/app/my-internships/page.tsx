...
const MyInternshipsPage = () => {
  ...
  const availableInternships = [
    ...
    },
    {
      ...
      company: "InnovateNow",
      description:
        "Learn product strategy and work with cross-functional teams",
      duration: "4 months",
      stipend: "$1000/month",
      location: "Austin, TX",
  ...
  const InternshipCard = ({
    ...
    <div className="group relative bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-slate-700 hover:border-gray-200 dark:hover:border-slate-600">
      ...
      <div className="flex items-start justify-between mb-4">
        <div
          className={`w-12 h-12 rounded-xl bg-gradient-to-br ${internship.color} flex items-center justify-center text-white text-xl shadow-lg`}
        >
      ...
      <div className="mb-4">
        ...
        <p className="text-gray-600 dark:text-gray-400 text-sm mb-3 line-clamp-2">
          {internship.description || internship.goal}
        </p>
      </div>
      ...
      {isEnrolled ? (
        <div className="mb-4">
          ...
          <div className="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400">
            <span>
              Week {internship.weeksPassed} of {internship.totalWeeks}
            </span>
            <span>
              {internship.tasksCompleted}/{internship.totalTasks} tasks
            </span>
          </div>
          ...
          <span
            className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-sm font-medium ${
              internship.status === "In Progress"
                ? "bg-blue-100 text-blue-700 dark:bg-blue-900/50 dark:text-blue-300"
                : internship.status === "Nearly Complete"
      ...
      <Link
        href={
          isEnrolled
            ? `/internships/${internship.id}/weeks/1`
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400">
                Track your professional experience journey
              </p>
            </div>
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-4">
                  <span className="text-sm text-gray-600 dark:text-gray-400">
                    {availableInternships.length} programs available
                  </span>
                  <button className="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-medium flex items-center gap-1">
                    View All
                    <ChevronRight className="w-4 h-4" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100 text-sm">
                      Showcase your best work and demonstrate your capabilities
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100 text-sm">
                      Don't wait until the deadline - early applications get
                      more attention
                    </p>
                  </div>
                </div>
